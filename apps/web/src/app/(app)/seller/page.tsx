      ...
      <ul className="mt-8 grid gap-3 sm:grid-cols-3">
        {[
          ...
          <li key={l.href}>
            <Link
              href={l.href}
              className="block rounded-xl border border-[color:var(--cv-border)] p-4 font-medium hover:border-[color:var(--cv-primary)]"
            >
              {l.label}
            </Link>
          </li>
        ...
        {sales ? (
          <>
            ...
            <table className="mt-4 w-full text-left text-sm">
              <thead>
                <tr className="border-b border-[color:var(--cv-border)]">
              ...
              <tbody>
                {sales.listings.map((t) => {
                  ...
                  return (
                    <tr key={t.id} className="border-b border-[color:var(--cv-border)]">
                ...
                {sales.listings.length === 0 ? (
                  <tr>
                    <td className="py-4 text-[color:var(--cv-text-secondary)]" colSpan={4}>
                      No listings yet.{' '}
