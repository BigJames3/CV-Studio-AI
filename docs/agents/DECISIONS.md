...
| HUMAN-UPGRADE         | Changement de plan                                        | PATCH no-op. Checkout crée une nouvelle session. Risque de second abonnement Stripe (BILL-002).                                  |
| HUMAN-PAST-DUE        | Accès pendant `past_due`                                  | Aujourd'hui le tier payant reste. Faut-il une grâce ?                                                                            |
